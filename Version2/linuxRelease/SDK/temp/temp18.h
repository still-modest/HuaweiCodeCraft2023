        ...
        for(int i=0;i<m_amount_workTable;i++)
        {
            if(m_worktables[i].classID>3)
            {
                if(m_robots[robot_id].objectID==3)
                {
                    ...
                    {
                        if( ((m_worktables[i].last <=last_time3 && m_worktables[i].last != -1) || ((m_worktables[i].sta_material & (1<<m_robots[robot_id].objectID))==0))&& (m_worktables[i].robot_link==4|| m_robots[m_worktables[i].robot_link].objectID!=3))//如果缺货
                        {
                ...
                if(m_robots[robot_id].objectID==1)
                {
                    ...
                    {
                        if(((m_worktables[i].last <=last_time3 && m_worktables[i].last != -1) || ((m_worktables[i].sta_material & (1<<m_robots[robot_id].objectID))==0)) && (m_worktables[i].robot_link==4|| m_robots[m_worktables[i].robot_link].objectID!=1))//如果缺货
                        {
                            dis.push_back(make_pair(sqrt((m_robots[robot_id].loc.x-m_worktables[i].loc.x)*(m_robots[robot_id].loc.x-m_worktables[i].loc.x)
                                     +(m_robots[robot_id].loc.y-m_worktables[i].loc.y)*(m_robots[robot_id].loc.y-m_worktables[i].loc.y)), i));
                        }
                ...
                if(m_robots[robot_id].objectID==2)
                {
                    ...
                    {
                        if(((m_worktables[i].last <=last_time3 && m_worktables[i].last != -1) || ((m_worktables[i].sta_material & (1<<m_robots[robot_id].objectID))==0)) && (m_worktables[i].robot_link==4|| m_robots[m_worktables[i].robot_link].objectID!=2))//如果缺货
                        {
                            dis.push_back(make_pair(sqrt((m_robots[robot_id].loc.x-m_worktables[i].loc.x)*(m_robots[robot_id].loc.x-m_worktables[i].loc.x)
                                     +(m_robots[robot_id].loc.y-m_worktables[i].loc.y)*(m_robots[robot_id].loc.y-m_worktables[i].loc.y)), i));
                        }
                ...
                if(m_robots[robot_id].objectID==4)
                {
                    ...
                    else
                    {
                        if(m_worktables[i].classID==7)
                        {
                            if(((m_worktables[i].last <=last_time3 && m_worktables[i].last != -1) || ((m_worktables[i].sta_material & (1<<m_robots[robot_id].objectID))==0)) && (m_worktables[i].robot_link==4 || m_robots[m_worktables[i].robot_link].objectID!=4))//如果缺货
                            {
                                dis.push_back(make_pair(sqrt((m_robots[robot_id].loc.x-m_worktables[i].loc.x)*(m_robots[robot_id].loc.x-m_worktables[i].loc.x)
                                     +(m_robots[robot_id].loc.y-m_worktables[i].loc.y)*(m_robots[robot_id].loc.y-m_worktables[i].loc.y)), i));
                            }
                ...
                if(m_robots[robot_id].objectID==5)
                {
                    ...
                    else
                    {
                        if(m_worktables[i].classID==7)
                        {
                            if(((m_worktables[i].last <=last_time3 && m_worktables[i].last != -1) || ((m_worktables[i].sta_material & (1<<m_robots[robot_id].objectID))==0)) && (m_worktables[i].robot_link==4|| m_robots[m_worktables[i].robot_link].objectID!=5))//如果缺货
                            {
                                dis.push_back(make_pair(sqrt((m_robots[robot_id].loc.x-m_worktables[i].loc.x)*(m_robots[robot_id].loc.x-m_worktables[i].loc.x)
                                     +(m_robots[robot_id].loc.y-m_worktables[i].loc.y)*(m_robots[robot_id].loc.y-m_worktables[i].loc.y)), i));
                            }
                ...
                if(m_robots[robot_id].objectID==6)
                {
                    ...
                    else
                    {
                        if(m_worktables[i].classID==7)
                        {
                            if(((m_worktables[i].last <=last_time3 && m_worktables[i].last != -1) || ((m_worktables[i].sta_material & (1<<m_robots[robot_id].objectID))==0)) && (m_worktables[i].robot_link==4|| m_robots[m_worktables[i].robot_link].objectID!=6))//如果缺货
                            {
                                dis.push_back(make_pair(sqrt((m_robots[robot_id].loc.x-m_worktables[i].loc.x)*(m_robots[robot_id].loc.x-m_worktables[i].loc.x)
                                     +(m_robots[robot_id].loc.y-m_worktables[i].loc.y)*(m_robots[robot_id].loc.y-m_worktables[i].loc.y)), i));
                            }
