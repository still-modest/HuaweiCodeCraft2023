...
vector<int> System::loop_4(int robot_id)
{
    vector<vector<int>> table_id;
    table_id.clear();
    int table_8=-1;
    for(int i=0;i<glo_count_workBench;i++)
    {
        if(glo_workBenches[i].classID==8) table_8=i;
    }
    for(int i=0;i<glo_count_workBench;i++)
    {
        if(glo_workBenches[i].classID==7 && (glo_workBenches[i].sta_component&(1<<6)==0) && ((glo_workBenches[i].last<=100 && glo_workBenches[i].last>0)||glo_workBenches[i].sta_produce)) {
            for (int j = 0; j < glo_count_workBench; j++) {
                if (glo_workBenches[j].classID == 6 && ((glo_workBenches[j].sta_component & (1 << 2) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
                        if ((glo_workBenches[k].classID == 2)) {
                            table_id.push_back({k, j, i, table_8});
                        }
                    }
                }
                if (glo_workBenches[j].classID == 6 && ((glo_workBenches[j].sta_component & (1 << 3) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
                        if ((glo_workBenches[k].classID == 3)) {
                            table_id.push_back({k, j, i, table_8});
                        }
                    }
                }
        ...
        if(glo_workBenches[i].classID==7 && (glo_workBenches[i].sta_component&(1<<5)==0) && ((glo_workBenches[i].last<=100 && glo_workBenches[i].last>0)||glo_workBenches[i].sta_produce)) {
            for (int j = 0; j < glo_count_workBench; j++) {
                if (glo_workBenches[j].classID == 5 && ((glo_workBenches[j].sta_component & (1 << 1) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
                        if ((glo_workBenches[k].classID == 1)) {
                            table_id.push_back({k, j, i, table_8});
                        }
                    }
                }
                if (glo_workBenches[j].classID == 5 && ((glo_workBenches[j].sta_component & (1 << 3) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
                        if ((glo_workBenches[k].classID == 3)) {
                            table_id.push_back({k, j, i, table_8});
        ...
        if(glo_workBenches[i].classID==7 && (glo_workBenches[i].sta_component&(1<<4)==0) && ((glo_workBenches[i].last<=100 && glo_workBenches[i].last>0)||glo_workBenches[i].sta_produce)) {
            for (int j = 0; j < glo_count_workBench; j++) {
                if (glo_workBenches[j].classID == 4 && ((glo_workBenches[j].sta_component & (1 << 2) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
                        if ((glo_workBenches[k].classID == 2)) {
                            table_id.push_back({k, j, i, table_8});
                ...
                if (glo_workBenches[j].classID == 4 && ((glo_workBenches[j].sta_component & (1 << 1) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
                        if ((glo_workBenches[k].classID == 1)) {
                            table_id.push_back({k, j, i, table_8});
    ...
    double dis=1000,temp_dis=1000;
    vector<int> tar_ids;
    if(table_id.size()>=1)
    {
        for(int i=0;i<table_id.size();i++)
        {
            temp_dis= sqrt((glo_workBenches[table_id[i][0]].loc.x-glo_robots[robot_id].loc.x)*(glo_workBenches[table_id[i][0]].loc.x-glo_robots[robot_id].loc.x)
                           +(glo_workBenches[table_id[i][0]].loc.y-glo_robots[robot_id].loc.y)*(glo_workBenches[table_id[i][0]].loc.y-glo_robots[robot_id].loc.y))
                      +sqrt((glo_workBenches[table_id[i][0]].loc.x-glo_workBenches[table_id[i][1]].loc.x)*(glo_workBenches[table_id[i][0]].loc.x-glo_workBenches[table_id[i][1]].loc.x)
                            +(glo_workBenches[table_id[i][0]].loc.y-glo_workBenches[table_id[i][1]].loc.y)*(glo_workBenches[table_id[i][0]].loc.y-glo_workBenches[table_id[i][1]].loc.y))
                      +sqrt((glo_workBenches[table_id[i][1]].loc.x-glo_workBenches[table_id[i][2]].loc.x)*(glo_workBenches[table_id[i][1]].loc.x-glo_workBenches[table_id[i][2]].loc.x)
                            +(glo_workBenches[table_id[i][1]].loc.y-glo_workBenches[table_id[i][2]].loc.y)*(glo_workBenches[table_id[i][1]].loc.y-glo_workBenches[table_id[i][2]].loc.y))
                      +sqrt((glo_workBenches[table_id[i][2]].loc.x-glo_workBenches[table_id[i][3]].loc.x)*(glo_workBenches[table_id[i][2]].loc.x-glo_workBenches[table_id[i][3]].loc.x)
                            +(glo_workBenches[table_id[i][2]].loc.y-glo_workBenches[table_id[i][3]].loc.y)*(glo_workBenches[table_id[i][2]].loc.y-glo_workBenches[table_id[i][3]].loc.y));
            if(temp_dis<dis)
            {
                dis=temp_dis;
                tar_ids=table_id[i];
...
vector<int> System::loop_3(int robot_id) {
    vector<vector<int>> table_id;
    table_id.clear();
    for(int i=0;i<glo_count_workBench;i++)
    {
        if(glo_workBenches[i].classID==7 && (glo_workBenches[i].sta_component&(1<<6)==0) && ((glo_workBenches[i].last>100 )||!glo_workBenches[i].sta_produce)) {
        ...
        if(glo_workBenches[i].classID==7 && (glo_workBenches[i].sta_component&(1<<5)==0) && ((glo_workBenches[i].last>200 )||!glo_workBenches[i].sta_produce)) {
            for (int j = 0; j < glo_count_workBench; j++) {
                if (glo_workBenches[j].classID == 5 && ((glo_workBenches[j].sta_component & (1 << 1) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
        ...
        if(glo_workBenches[i].classID==7 && (glo_workBenches[i].sta_component&(1<<4)==0) && ((glo_workBenches[i].last>200 )||!glo_workBenches[i].sta_produce)) {
            for (int j = 0; j < glo_count_workBench; j++) {
                if (glo_workBenches[j].classID == 4 && ((glo_workBenches[j].sta_component & (1 << 2) == 0)) &&
                    ((glo_workBenches[j].last <= 50 && glo_workBenches[j].last > 0) || glo_workBenches[j].sta_produce)) {
                    for (int k = 0; k < glo_count_workBench; k++) {
    ...
    for(int i=0;i<glo_count_workBench;i++)
    {
        ...
        if(glo_workBenches[i].classID==6)
        {
            ...
            if((glo_workBenches[i].sta_component &(1<<3))==0 && (check_robotlink(i,2,3))) //缺3
            {
                ...
                for(int j=0;j<glo_count_workBench;j++)
                {
                    if(glo_workBenches[j].classID==3&& (glo_workBenches[j].sta_produce || (glo_workBenches[j].last<=30 &&glo_workBenches[j].last>0)))
                    {
                        vector<int> table_temp;
                        table_temp.push_back(j);
                        table_temp.push_back(i);
        ...
        if(glo_workBenches[i].classID==5)
        {
            ...
            if((glo_workBenches[i].sta_component & (1<<1))==0&& check_robotlink(i,2,1)) //缺1
            {
                for(int j=0;j<glo_count_workBench;j++)
                {
                    if(glo_workBenches[j].classID==1&& (glo_workBenches[j].sta_produce || (glo_workBenches[j].last<=30 &&glo_workBenches[j].last>0))) {
                        vector<int> table_temp;
                        table_temp.push_back(j);
                        table_temp.push_back(i);
                        double dis_temp=sqrt((glo_robots[robot_id].loc.x - glo_workBenches[j].loc.x) *
...
vector<int> System::cost_fun(vector<pair<double,vector<int>>> dis_all, int robot_id)
{
    ...
    for(int i=0;i<lost_rate.size();i++)
    {
        ...
        if(glo_workBenches[lost_rate[i].second[0]].classID==2)
        {
            ...
            if(glo_workBenches[lost_rate[i].second[1]].classID==4 && glo_workBenches[lost_rate[i].second[1]].sta_component==2)
            {
                if(map_id==1)
                {
                    monney_temp=monney_temp+850;
            ...
            if(glo_workBenches[lost_rate[i].second[1]].classID==6 && glo_workBenches[lost_rate[i].second[1]].sta_component==8)
            {
                if(map_id==1)
                {
        ...
        if(glo_workBenches[lost_rate[i].second[0]].classID==3)
        {
            ...
            if(glo_workBenches[lost_rate[i].second[1]].classID==5 && glo_workBenches[lost_rate[i].second[1]].sta_component==2)
            {
                if(map_id==1)
                {
                    monney_temp=monney_temp+850;
            ...
            if(glo_workBenches[lost_rate[i].second[1]].classID==6 && glo_workBenches[lost_rate[i].second[1]].sta_component==4)
            {
                if(map_id==1)
                {
                    monney_temp=monney_temp+1000;
        ...
        if(glo_workBenches[lost_rate[i].second[0]].classID==4)
        {
            ...
            if(map_id==1)
            {
                monney_temp=monney_temp+(glo_workBenches[lost_rate[i].second[1]].ID-10)*200;
            }
            if(map_id==2)
            {
...
void System::robot_actionv2()
{
    ...
    for(int i=0;i<4;i++)
    {
        if(!glo_robots[i].arrived_1 && !glo_robots[i].arrived_2 && glo_robots[i].busy)
        {
            ...
            if(glo_robots[i].arrived && glo_frameID<=8750)
            {
...
int System::find_recenttable(int robot_id)
{
    int target_id=-1;

    if(glo_robots[robot_id].objectID==0)//如果没有带，此刻空闲可以取
    {
        int last=0;
        ...
        for(int i=0;i<glo_count_workBench;i++) {
            if (glo_workBenches[i].classID == 7 &&((glo_workBenches[i].last<=last && glo_workBenches[i].last>=0) || glo_workBenches[i].sta_produce) && glo_workBenches[i].robot_link >= robot_id&&glo_frameID<=8850) {
                dis_temp = (int)(sqrt((glo_robots[robot_id].loc.x - glo_workBenches[i].loc.x) *
                                (glo_robots[robot_id].loc.x - glo_workBenches[i].loc.x)
                                + (glo_robots[robot_id].loc.y - glo_workBenches[i].loc.y) *
                                  (glo_robots[robot_id].loc.y - glo_workBenches[i].loc.y))*100)/100.0;
                if (dis_temp <= dis) {
                    dis = dis_temp;
                    target_id = i;
                }
        ...
        for(int i=0;i<glo_count_workBench;i++){
            if ((glo_workBenches[i].classID == 4 || glo_workBenches[i].classID == 5 || glo_workBenches[i].classID == 6) &&
                ((glo_workBenches[i].last<=30 && glo_workBenches[i].last>=0) || glo_workBenches[i].sta_produce) && glo_workBenches[i].robot_link >= robot_id && glo_frameID<=8800) {
                if (class_1_enough && glo_workBenches[i].classID == 1) continue;
                if (class_2_enough && glo_workBenches[i].classID == 2) continue;
                if (class_3_enough && glo_workBenches[i].classID == 3) continue;
                if (class_4_enough && glo_workBenches[i].classID == 4) continue;
                if (class_5_enough && glo_workBenches[i].classID == 5) continue;
                if (class_6_enough && glo_workBenches[i].classID == 6) continue;
                dis_temp = (int)(sqrt((glo_robots[robot_id].loc.x - glo_workBenches[i].loc.x) *
                                (glo_robots[robot_id].loc.x - glo_workBenches[i].loc.x)
                                + (glo_robots[robot_id].loc.y - glo_workBenches[i].loc.y) *
                                  (glo_robots[robot_id].loc.y - glo_workBenches[i].loc.y))*100)/100.0;
        ...
        if((class_4_enough && class_5_enough && !class_6_enough)||(class_6_enough && class_4_enough && !class_5_enough)||(class_6_enough && class_5_enough && !class_4_enough))
        {
        ...
        for(int i=0;i<glo_count_workBench;i++){
            if((glo_workBenches[i].classID==1 || glo_workBenches[i].classID==2 || glo_workBenches[i].classID==3)  && glo_workBenches[i].robot_link>=robot_id&& glo_frameID<=8800)//如果有货
            {
                if(class_1_enough && glo_workBenches[i].classID==1) continue;
                if(class_2_enough && glo_workBenches[i].classID==2) continue;
                if(class_3_enough && glo_workBenches[i].classID==3) continue;
                ...
                if(class_5_enough && glo_workBenches[i].classID==5) continue;
                if(class_6_enough && glo_workBenches[i].classID==6) continue;
                dis_temp=(int)(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                              +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y))*100)/100.0;
    ...
    if(glo_robots[robot_id].objectID!=0  && glo_robots[robot_id].target_table==-1)//如果带了，找最近的可以卖的
    {
        vector<double> dis;
        for(int i=0;i<glo_count_workBench;i++)
        {
            if(glo_workBenches[i].classID>3)
            {
                if(glo_robots[robot_id].objectID==3)
                {
                    if(glo_workBenches[i].classID==6 || glo_workBenches[i].classID==5)
                    {
                        if(((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0)&& (glo_workBenches[i].robot_link==4|| glo_robots[glo_workBenches[i].robot_link].objectID!=3))//如果缺货
                        {
                            dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                               +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                        }
                    }
                }
                if(glo_robots[robot_id].objectID==1)
                {
                    if(glo_workBenches[i].classID==4 || glo_workBenches[i].classID==5)
                    {
                        if(((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0) && (glo_workBenches[i].robot_link==4|| glo_robots[glo_workBenches[i].robot_link].objectID!=1))//如果缺货
                        {
                            dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                               +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                        }
                ...
                if(glo_robots[robot_id].objectID==2)
                {
                    if(glo_workBenches[i].classID==4 || glo_workBenches[i].classID==6)
                    {
                        if(((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0)&& (glo_workBenches[i].robot_link==4|| glo_robots[glo_workBenches[i].robot_link].objectID!=2))//如果缺货
                        {
                            dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                               +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                        }
                ...
                if(glo_robots[robot_id].objectID==4)
                {
                    if(no_7)
                    {
                        if(glo_workBenches[i].classID==9)
                        {
                            if(((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0))//如果缺货
                            {
                                dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                                   +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                    ...
                    else
                    {
                        if(glo_workBenches[i].classID==7)
                        {
                            if((((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0)||(glo_workBenches[i].last<=30 && glo_workBenches[i].last>0 && glo_workBenches[i].sta_component ==112))&& (glo_robots[glo_workBenches[i].robot_link].objectID!=4))//如果缺货
                            {
                                dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                                   +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                            }
                ...
                if(glo_robots[robot_id].objectID==5)
                {
                    if(no_7)
                    {
                        if(glo_workBenches[i].classID==9)
                    ...
                    else
                    {
                        if(glo_workBenches[i].classID==7)
                        {
                            if((((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0)||(glo_workBenches[i].last<=30 && glo_workBenches[i].last>0 && glo_workBenches[i].sta_component ==112))&& (glo_robots[glo_workBenches[i].robot_link].objectID!=5))//如果缺货
                            {
                                dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                                   +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                            }
                ...
                if(glo_robots[robot_id].objectID==6)
                {
                    if(no_7)
                    {
                        if(glo_workBenches[i].classID==9)
                    ...
                    else
                    {
                        if(glo_workBenches[i].classID==7)
                        {
                            if((((glo_workBenches[i].sta_component & (1<<glo_robots[robot_id].objectID))==0)||(glo_workBenches[i].last<=30 && glo_workBenches[i].last>0 && glo_workBenches[i].sta_component ==112))&& (glo_robots[glo_workBenches[i].robot_link].objectID!=6))//如果缺货
                            {
                                dis.push_back(sqrt((glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[i].loc.x)
                                                   +(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[i].loc.y)));
                            }
                ...
                if(glo_robots[robot_id].objectID==7)
                {
                    if(glo_workBenches[i].classID==8||glo_workBenches[i].classID==9)
                    {
        ...
        if(dis.size()>=1)
        {
            ...
            if(dis.size()==1)
            {
                for(int m=0;m<glo_count_workBench;m++)
                {
                    if(abs(dis[0]-sqrt((glo_robots[robot_id].loc.x-glo_workBenches[m].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[m].loc.x)
                                       +(glo_robots[robot_id].loc.y-glo_workBenches[m].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[m].loc.y)))<=0.001)
                    {
                        target_id=m;
                    }
                }
            ...
            else
            {
                for(int m=0;m<glo_count_workBench;m++)
                {
                    ...
                    if(abs(dis[1]-sqrt((glo_robots[robot_id].loc.x-glo_workBenches[m].loc.x)*(glo_robots[robot_id].loc.x-glo_workBenches[m].loc.x)
                                       +(glo_robots[robot_id].loc.y-glo_workBenches[m].loc.y)*(glo_robots[robot_id].loc.y-glo_workBenches[m].loc.y)))<=0.001)
                    {
                        target_temp1=m;
                    }
                }
                if(abs(target_temp0-target_temp1)>=80)
                {
                ...
                else
                {
                    if(glo_robots[robot_id].objectID==1)
                    {
                        if(((glo_workBenches[target_temp1].sta_component & (1<<2))||(glo_workBenches[target_temp1].sta_component & (1<<3)))&& ((glo_workBenches[target_temp0].sta_component & (1<<2))==0&&(glo_workBenches[target_temp0].sta_component & (1<<3))==0))
                        {
                    ...
                    if(glo_robots[robot_id].objectID==2)
                    {
                        if(((glo_workBenches[target_temp1].sta_component & (1<<1))||(glo_workBenches[target_temp1].sta_component & (1<<3)))&& ((glo_workBenches[target_temp0].sta_component & (1<<1))==0&&(glo_workBenches[target_temp0].sta_component & (1<<3))==0))
                        {
                            target_id=target_temp1;
                        }
                        else
                    ...
                    if(glo_robots[robot_id].objectID==3)
                    {
                        if(((glo_workBenches[target_temp1].sta_component & (1<<1))||(glo_workBenches[target_temp1].sta_component & (1<<2)))&& ((glo_workBenches[target_temp0].sta_component & (1<<1))==0&&(glo_workBenches[target_temp0].sta_component & (1<<2))==0))
                        {
                            target_id=target_temp1;
                        }
                        else
                    ...
                    if(glo_robots[robot_id].objectID==4)
                    {
                        if(glo_workBenches[target_temp0].last==-1 && glo_workBenches[target_temp0].sta_component ==96 && (glo_workBenches[target_temp1].last>0))
                        {
                            return target_temp0;
                        }
                        if(glo_workBenches[target_temp1].last==-1 && glo_workBenches[target_temp1].sta_component ==96 && (glo_workBenches[target_temp0].last>0))
                        {
                            return target_temp1;
                        }
                        if((((glo_workBenches[target_temp1].sta_component & (1<<5))&&(glo_workBenches[target_temp1].sta_component & (1<<6)))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0))
                           ||(((glo_workBenches[target_temp1].sta_component & (1<<5))&&(glo_robots[glo_workBenches[target_temp1].robot_link].objectID==6))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0))
                           ||(((glo_workBenches[target_temp1].sta_component & (1<<6))&&(glo_robots[glo_workBenches[target_temp1].robot_link].objectID==5))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0)))
                        {
                            target_id=target_temp1;
                        }
                        else
                    ...
                    if(glo_robots[robot_id].objectID==5)
                    {
                        if(glo_workBenches[target_temp0].last==-1 && glo_workBenches[target_temp0].sta_component ==80 && (glo_workBenches[target_temp1].last>0))
                        {
                            return target_temp0;
                        }
                        if(glo_workBenches[target_temp1].last==-1 && glo_workBenches[target_temp1].sta_component ==80 && (glo_workBenches[target_temp0].last>0))
                        {
                            return target_temp1;
                        }
                        if((((glo_workBenches[target_temp1].sta_component & (1<<4))&&(glo_workBenches[target_temp1].sta_component & (1<<6)))&& ((glo_workBenches[target_temp0].sta_component & (1<<4))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0))
                           ||(((glo_workBenches[target_temp1].sta_component & (1<<4))&&(glo_robots[glo_workBenches[target_temp1].robot_link].objectID==6))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0))
                           ||(((glo_workBenches[target_temp1].sta_component & (1<<6))&&(glo_robots[glo_workBenches[target_temp1].robot_link].objectID==4))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0)))
                        {
                            target_id=target_temp1;
                        }
                        else
                    ...
                    if(glo_robots[robot_id].objectID==6)
                    {
                        if(glo_workBenches[target_temp0].last==-1 && glo_workBenches[target_temp0].sta_component ==48 && (glo_workBenches[target_temp1].last>0))
                        {
                            return target_temp0;
                        }
                        if(glo_workBenches[target_temp1].last==-1 && glo_workBenches[target_temp1].sta_component ==48 && (glo_workBenches[target_temp0].last>0))
                        {
                            return target_temp1;
                        }
                        if((((glo_workBenches[target_temp1].sta_component & (1<<5))&&(glo_workBenches[target_temp1].sta_component & (1<<4)))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<4))==0))
                           ||(((glo_workBenches[target_temp1].sta_component & (1<<5))&&(glo_robots[glo_workBenches[target_temp1].robot_link].objectID==4))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0))
                           ||(((glo_workBenches[target_temp1].sta_component & (1<<4))&&(glo_robots[glo_workBenches[target_temp1].robot_link].objectID==5))&& ((glo_workBenches[target_temp0].sta_component & (1<<5))==0||(glo_workBenches[target_temp0].sta_component & (1<<6))==0)))
                        {
                            target_id=target_temp1;
                        }
                        else
...
void System::robot_action()
{
    vector<int> tar_idloop;
    ...
    for(int i=0;i<4;i++)
    {
        ...
        if(glo_robots[i].objectID==0  )
        {
            tar_idloop=loop_3(i);
                ...
                if(tar_id!=-1)
                {
                    glo_workBenches[tar_id].robot_link=i;
                    glo_robots[i].target_table=tar_id;
                    glo_robots[i].order=1;//去买
                }
...
void System::robot_to_table()
{
    for(int i=0;i<4;i++)
    {
        if(glo_robots[i].target_table!=-1)//有目标工作台
        {
            set_Pointv4(i,glo_workBenches[glo_robots[i].target_table].loc.x,glo_workBenches[glo_robots[i].target_table].loc.y);
            if(glo_robots[i].arrived)
            {
                if(glo_robots[i].order==1)
                {
                    control(glo_robots[i].ID, BUY_ACTION);
                }
                if(glo_robots[i].order==2)
                {
                    control(glo_robots[i].ID, SELL_ACTION);
                }
                glo_robots[i].order=0;
                glo_workBenches[glo_robots[i].target_table].robot_link=4;
                glo_robots[i].target_table=-1;
