...
vector<int> System::scan_mostneed(int robot_id)
{
    ...
    for(int i=0;i<glo_count_workBench;i++)
    {
        if(glo_workBenches[i].classID==9)
        {
            ...
            {
                if(glo_workBenches[j].classID==1 && (glo_workBenches[j].sta_produce ) && map_id!=1)
                {
                ...
                if(glo_workBenches[j].classID==2 && (glo_workBenches[j].sta_produce )&& map_id!=1)
                {
                    vector<int> table_temp;
                    table_temp.push_back(j);
                    table_temp.push_back(i);
                ...
                if(glo_workBenches[j].classID==3 && (glo_workBenches[j].sta_produce) && map_id!=1)
                {
                    vector<int> table_temp;
                    table_temp.push_back(j);
                    table_temp.push_back(i);
        ...
        if(glo_workBenches[i].classID==7)
        {
            ...
            if(map_id==1)
            {
                if(((glo_workBenches[i].sta_component & (1<<4))==0) && check_robotlink(i,2,4) && glo_workBenches[i].ID==17)
                {
                    for(int j=0;j<glo_count_workBench;j++)
                    {
            ...
            if(map_id==1)
            {
                if(((glo_workBenches[i].sta_component & (1<<5))==0) && check_robotlink(i,2,5) &&  glo_workBenches[i].ID==17)
                {
                    for(int j=0;j<glo_count_workBench;j++)
                    {
            ...
            if(map_id==1)
            {
                if(((glo_workBenches[i].sta_component & (1<<6))==0) && check_robotlink(i,2,6) &&  glo_workBenches[i].ID==17)
                {
                    for(int j=0;j<glo_count_workBench;j++)
                    {
...
vector<pair<float, float>> System::avoid_obs1(int robotID)
{
    ...
    if((glo_robots[robotID].loc.x<5 && glo_robots[robotID].loc.y < 5))//save
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID && (glo_robots[i].loc.x < glo_robots[robotID].loc.x) && (glo_robots[i].loc.y < glo_robots[robotID].loc.y) && (glo_robots[robotID].direct >= -M_PI && glo_robots[robotID].direct <= -M_PI/2))
            {
    ...
    else if((glo_robots[robotID].loc.x<5 && glo_robots[robotID].loc.y > 45))
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID && (glo_robots[i].loc.x < glo_robots[robotID].loc.x) && (glo_robots[i].loc.y > glo_robots[robotID].loc.y) && (glo_robots[robotID].direct >= M_PI/2 && glo_robots[robotID].direct <= M_PI))
            {
                vel = 0;
            }
        }
    ...
    else if((glo_robots[robotID].loc.x>45 && glo_robots[robotID].loc.y < 5))
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID && (glo_robots[i].loc.x > glo_robots[robotID].loc.x) && (glo_robots[i].loc.y < glo_robots[robotID].loc.y) && (glo_robots[robotID].direct >= -M_PI/2 && glo_robots[robotID].direct <= 0))
            {
                vel = 0;
            }
        }
    ...
    else if((glo_robots[robotID].loc.x>45 && glo_robots[robotID].loc.y >45))
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID && (glo_robots[i].loc.x > glo_robots[robotID].loc.x) && (glo_robots[i].loc.y > glo_robots[robotID].loc.y) && (glo_robots[robotID].direct >= 0 && glo_robots[robotID].direct <= M_PI/2))
            {
                vel = 0;
            }
        }
    ...
    else if((glo_robots[robotID].loc.x> 20 && glo_robots[robotID].loc.x < 30 && glo_robots[robotID].loc.y >45))
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID)
            {   
                if((abs(glo_robots[i].loc.x-25) < abs(glo_robots[robotID].loc.x-25)) && (glo_robots[i].loc.y > glo_robots[robotID].loc.y) && (glo_robots[robotID].direct >= 0 && glo_robots[robotID].direct <= M_PI))
                {
                    vel = 0;
                }
    ...
    else if((glo_robots[robotID].loc.x> 20 && glo_robots[robotID].loc.x < 30 && glo_robots[robotID].loc.y <5))
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID)
            {   
                if((abs(glo_robots[i].loc.x-25) < abs(glo_robots[robotID].loc.x-25)) && (glo_robots[i].loc.y < glo_robots[robotID].loc.y) && (glo_robots[robotID].direct >= -M_PI && glo_robots[robotID].direct <= 0))
                {
                    vel = 0;
                }
    ...
    else if((glo_robots[robotID].loc.y> 20 && glo_robots[robotID].loc.y < 30 && glo_robots[robotID].loc.x >45))
    {
        for(int i = 0;i < 4; i++)
        {
            if(i != robotID)
            {   
                if((abs(glo_robots[i].loc.y-25) < abs(glo_robots[robotID].loc.y-25)) && (glo_robots[i].loc.x > glo_robots[robotID].loc.x) && (glo_robots[robotID].direct >= -M_PI/2 && glo_robots[robotID].direct <= M_PI/2))
                {
                    vel = 0;
                }
